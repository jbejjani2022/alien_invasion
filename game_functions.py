...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    collisions = pygame.sprite.groupcollide(bullets, aliens,
                                            ai_settings.bullet_delete_on_collision, True)
    if collisions:
    ...
    if len(aliens) == 0:
        # If the entire fleet is destroyed, destroy existing bullets, speed up game, and create new fleet.
        bullets.empty()
